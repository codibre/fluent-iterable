...
declare module './types' {
  ...
  interface FluentIterable<T> {
     ...
     */
    group<R extends keyof T>(mapper: R): FluentIterable<FluentGroup<T, T[R]>>;
     ...
     */
    forEachAsync(mapper: keyof T): Promise<void>;
     ...
     */
    execute(action: keyof T): FluentIterable<T>;
     ...
     */
    executeAsync(action: keyof T): FluentAsyncIterable<T>;
