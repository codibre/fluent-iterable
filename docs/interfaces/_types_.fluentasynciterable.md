[fluent-iterable - v1.1.0](../README.md) › ["types"](../modules/_types_.md) › [FluentAsyncIterable](_types_.fluentasynciterable.md)
...
▸ **forEach**‹**R**›(`mapper`: [AsyncMapper](_types_.asyncmapper.md)‹T, R›): *Promise‹void›*
